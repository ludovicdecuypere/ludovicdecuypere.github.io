...
format:
  html:
    mainfont: sans-serif
---
Flanders Fields is famous for its Great War battlefields and rows of red poppies. But in the nineties, Ypres was also the epicenter of the emerging field of speech technology, with "Lernout & Hauspie" ("L&H) as the star company of "Flanders Language Valley", a name coined to mimick "Silicon Valley". 

The movie Dust (2026), directed by Anke Blondé and starring Arieh Worthalter and Jan Hammenecker, is an unofficial portrayal of the demise of Lernout & Hauspie as it collapsed into bankruptcy in November 2000. The story that inspired *Dust* is clearly inspired by historical events, although there are no explicit historical references to L&H. Yet, the iconic references are obvious to those who know the historical background.

As I argue in my chapter for *The Oxford Handbook of Iconicity in Language* [@DeCuypere2026OUP], the distinction between similarity and iconicity is fundamental to understand how iconicity operates. If one doesn't know anything about the historical events that the movie is based on, one can still enjoy and understand the movie. But the similarity between the movie and the historical events is there, and for those who do recognize the historical references, this similarity yields an effect. The cognitive act of recognition is essentially an iconic act. For instance, failing to recognize a face is because the similarity has no cognitive effect, not because there is no similarity. In other words, similarity is the resemblance between a sign and its object, whereas iconicity is the effect that this resemblance has on the interpretant of the sign.
...
The poster of the movie is a semiotic gem, a feast of intertextual and iconic references.
...
Notice that the red line goes completely flatline under the letter *T*. Is it my imagination, or can does one hear -- or even phonotactically feel -- the flatline in the pronunciation of the sound [t]? Is my interpretation "correct"? Or is this what Umberto Eco [-@eco1992interpretation] meant with "overinterpretation" ? 

My interpretation might only be in mine eye, with me as the beholder. I'm perfectly fine with that. However, it would be problematic to claim that my interpretation is part of the meaning of *dust*. And this is exactly the problem I have with psycholinguistic rating experiments that aim to measure the iconicity of the lexicon.

The photograph of the two men on the poster can also be interpreted iconicially. Note that the photograph is ripped into pieces as if it went through a paper shredder. This might reflect the broken relationship between the two protagonists, the broken dreams of days gone by, or perhaps even the fragmented memories one has of historical events. The shredded picture could even suggest a kind of multiverse historical rendering: the past can only be reconstructed, and any reconstruction necessarily falls short of what really happened.
